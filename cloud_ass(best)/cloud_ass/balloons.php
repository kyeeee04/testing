						...
						?>
							<div class="product-row">
								...
								foreach ($product_array as $key => $product) :
									...
									if ($key < 9) continue; // Skip items before index 9
									if ($count >= 9) break; // Stop after displaying 8 items

									// Display the item
								?>
								<div class="product-column">
									<form method="post" action="balloons.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
								...
								<?php 
									$count++;
									if ($count % 3 == 0 && $count < 9) echo '</div><div class="product-row">'; // Start a new row after every third item (except the last row)
								?>
